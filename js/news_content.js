function get_target_news_F() {
  ...
  $.ajax({
    ...
    success: function (res) {
      ...
      // alert("#")
      // window.location.assign(`http://192.168.43.56:5501/admin_news_content.html?id=${target_id}`);
      ...
      const news_date = `
                <div>${res.createTime.substr(0, 4)}/${res.createTime.substr(
        5,
        2
      )}/${res.createTime.substr(8, 2)}</div>
            `;
      const content = `
