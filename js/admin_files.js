function get_files_doc() {
    var API = "http://192.168.43.56:5002/api/FileUpload/getallfiles"
        ...
        success: function (res) {
            ...
            for (i = 0; i < res.length; i++) {
                ...
                <tr id = files${i + 1}>
                    <th scope="row">${i + 1}</th>
                    <td>
                        <a class="files_hover" target="_blank" href="http://192.168.43.56:5002/api/FileUpload/downloadfile/${res[i].file_Id}" download="${res[i].fileName}">
                            ${res[i].fileName}
                        </a>
                    </td>
