        ...
        <div class="container container_footer_set">
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-4 footer_content">
                    <a href="https://www.hpa.gov.tw/Home/Index.aspx" target="_blank"><img class="footer_img_set"
                            src="./image/footer_2-removebg-preview.png" alt=""></a>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 footer_content">
                    <a href="http://www.tchca68.org/" target="_blank"><img class="footer_img_set"
                            src="./image/footer_3.png" alt=""></a>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 footer_content">
